...
class ZoomIn(BaseTransform): 
    ...
    def transform(self, image_nd, clicks_lists: List[List[Click]]):
        ...
        # print(self._object_roi)
        # print(image_nd.dtype)
        # tp = image_nd.cpu().numpy()
        # cv2.rectangle(tp, (0, 94), (168, 294), (0,0,255), 2)
        # cv2.imshow("emp",np.uint8(tp))
        self._roi_image = get_roi_image_nd(image_nd, self._object_roi, self.target_size)
        # print(self._roi_image.shape)
    ...
    def check_possible_recalculation(self):
        ...
        #     print('kkkk1')
        # if self._object_roi is not None:
        #     print('kkkk2')
        # if self.skip_clicks > 0:
        #     print('kkkk3')    
        ...
        if pred_mask.sum() > 0:
            ...
            # print('{},{}'.format(possible_object_roi,image_roi.shape))
